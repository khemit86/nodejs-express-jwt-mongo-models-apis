...
module.exports.validate = (method) => {
  switch (method) {
    ...
    case 'addCMS': {
      return [
        body('meta_title').notEmpty().withMessage('META_TITLE_IS_REQUIRED'),
        body('meta_keyword').notEmpty().withMessage('META_KEYWORD_IS_REQUIRED'),
        body('meta_description').notEmpty().withMessage('META_DESCRIPTION_IS_REQUIRED'),
        body('title').notEmpty().withMessage('TITLE_IS_REQUIRED'),
        body('description').notEmpty().withMessage('DESCRIPTION_IS_REQUIRED'),
        validatorMiddleware
      ]
